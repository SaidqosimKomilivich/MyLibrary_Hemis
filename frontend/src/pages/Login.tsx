                    ...
                    {!blockedUntil && captchaText && (
                        <div className="flex flex-col gap-1.5 animate-fade-in">
                            ...
                            <div className="flex gap-2">
                                <div className="flex items-center justify-center min-w-[100px] shrink-0 bg-surface-hover border border-border rounded-md text-text font-bold font-mono text-[1.2rem] shadow-sm select-none">
                                    {captchaText} =
                                </div>
                            ...
                            {/* <p className="text-[0.75rem] text-text-muted opacity-80 mt-0.5">
                                Xavfsizlik maqsadida ushbu matematik amalni bajaring.
                                Xato kiritish blokirovka qilinishiga olib kelishi mumkin.
                            </p> */}
                        </div>
                    )}
