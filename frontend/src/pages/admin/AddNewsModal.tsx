                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs text-text-muted">
                                Rasmlarni to'g'ridan-to'g'ri joylashtirishingiz yoki rasm tugmasi orqali yuklashingiz mumkin
                            </span>
                        </div>
                        <div className="rounded-2xl overflow-hidden border border-border shadow-inner bg-canvas">
                            <Editor
